...
class DockSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Dock::insert([
            ...
            ['name' => 'Kronstadt Naval Base', 'location' => 'Russia'],
            ...
            ['name' => 'Naval Base Yokosuka', 'location' => 'Japan'],
            ['name' => 'Naval Base Portsmouth', 'location' => 'UK'],
            ['name' => 'Naval Base Kiel', 'location' => 'Germany'],
            ['name' => 'Kure Naval Base', 'location' => 'Japan'],
