...
class ShipPolicy
{
    ...
    {
        return $user->can('delete_any_ship');
    }
     ...
     */
    public function replicate(User $user, Ship $ship): bool
    {
